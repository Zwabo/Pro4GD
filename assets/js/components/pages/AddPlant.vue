...
<path d="M189.9,8.3c-55.8,0-101.1,45.3-101.1,101.1c0,55.8,45.3,101.1,101.1,101.1c55.8,0,101.1-45.3,101.1-101.1
	...
	<path d="M19.1,259.3V276h-8.8v-47.6h15.5c3.2,0,5.9,0.4,8.3,1.1c2.3,0.7,4.2,1.8,5.8,3.1c1.5,1.3,2.6,2.9,3.4,4.8
        ...
        <div class="col-5 text-center">
            <form>
                <p class="search">Neue Pflanze hinzufügen</p>
                <div class="form-group row">
                    <label for="Name" class="col-sm-2 col-form-label">Name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm searchBarDatabase" id="Name" placeholder="Aloe Vera">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="alNamen" class="col-sm-2 col-form-label">Alternative Namen</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm searchBarDatabase" id="alNamen" placeholder="Echte Aloe">
                    </div>
                </div>
                ...
                <button class="buttonWhiteSearch">Hinzufügen</button>
            </form>
        </div>
