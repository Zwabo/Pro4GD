        ...
        <div class="row bgDarkGreen fontWhite rowsIndex paddingLeftRight">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4 selfAlignCenter left">
                        <div class="container-fluid">
                    ...
                    <div class="oneColumn whiteLine"></div>

                    <div class="col-lg-8 selfAlignCenter right">
                        <div class="container-fluid" id="registerForm">
                            <div>
                                <h1 class="loginRegisterh1">Registriere dich!</h1>
                            </div>
