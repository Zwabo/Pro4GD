...
<path class="st0" d="M362.8,227.9c0,14.2-11.4,25.6-25.6,25.6l-221.8,0c-14.2,0-25.6-11.4-25.6-25.6s11.4-25.6,25.6-25.6h221.8
	C351.4,202.3,362.8,213.7,362.8,227.9z"/>
        ...
        <div class="row sortCategories dropShadow pflegetipps" id="sortCategoriesFirst">
            <div class="col-lg-11">
                <div class="row">
            ...
            <div class="col-lg-1 svgSortCategories text-right">
                <svg class="arrow" xmlns="http://www.w3.org/2000/svg" width="41" height="49" viewBox="0 0 41 49">
            ...
            <div class="row sortCategories dropShadow neuigkeiten">
                <div class="col-lg-11">
                    <div class="row">
                        <div class="svgSortCategories">
